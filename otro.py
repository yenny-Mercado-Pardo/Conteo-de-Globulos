...
#13
path = "image/c_198.jpeg"
#path = "imagenes/17.jpg"
...
print(len(regions))
titles = ['Imagen original','Imagen Gris','Clahe','Otsu','opening','sure_bg','sure_fg','d_transform_f','unknown','markers','img_8byte','img2']
#titles = ['unknown','markers','img_8byte','img2']
images = [img_8byte,gray,clahe_cl1,thresh,opening,sure_bg,sure_fg,dist_transform_fill,unknown,markers,img_8byte,img2]
